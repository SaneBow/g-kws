...
interpreter1 = tf.lite.Interpreter(model_path="/home/pi/google-kws/models2/crnn_state_vad/quantize_opt_for_size_tflite_stream_state_external/stream_state_external.tflite")
...
def sd_callback(rec, frames, time, status):
    ...
    print(np.argmax(output_data[0]), output_data[0][np.argmax(output_data[0])])
